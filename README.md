...
<a href="https://slack.com/oauth/v2/authorize?client_id=6365238421.521412341143&scope=commands,app_mentions:read,channels:read,chat:write,groups:read,im:history,im:read,im:write,mpim:history,mpim:read,mpim:write,team:read,users:read,users:write&redirect_uri=https://tefter.app/microlith/auth/slack">
  <img
    alt="Add to Slack"
    height="40"
    width="139"
